...
| [2 — Train nhỏ](phase-2-small-train.md) | 1.3, 2.1, 2.2, 5.2 | RTX 24GB (SSH), Kaggle GPU cho debug | Arm A + Arm B trained (Kaggle GPU); Arm C viết xong (local-tested); chưa compute-matched; backbone (2.1/2.2) chưa viết |
