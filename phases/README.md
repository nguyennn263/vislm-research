...
| [2 — Train nhỏ](phase-2-small-train.md) | 1.3, 2.1, 2.2, 5.2 | RTX 24GB (SSH), Kaggle GPU cho debug | A/B/C trained ở 2 quy mô + compute-matched; tín hiệu nhất quán: C > B, cả 2 thua A (bits/byte); backbone (2.1/2.2) chưa viết |
