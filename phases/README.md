...
| [2 — Train nhỏ](phase-2-small-train.md) | 1.3, 2.1, 2.2, 5.2 | RTX 24GB (SSH), Kaggle GPU cho debug | A/B/C trained + compute-matched (Kaggle GPU); tín hiệu debug-scale: C > B; backbone (2.1/2.2) chưa viết |
