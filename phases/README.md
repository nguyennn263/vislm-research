...
| [2 — Train nhỏ](phase-2-small-train.md) | 1.3, 2.1, 2.2, 5.2 | Kaggle GPU (đủ dùng ở scale này) | A/B/C trained ở 3 quy mô (30→500→5000 bước) + checkpoint/resume; A>>{B,C} và khoảng cách GIÃN theo thời gian train (chưa như kỳ vọng); backbone (2.1/2.2) chưa viết |
